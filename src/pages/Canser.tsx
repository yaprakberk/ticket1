  ...
  return (
    <div>
      <div className="concert-container">
        <ConsertBox
          date="20 NİSAN"
          destriptions="Etkinlik Hakkında Bilmeniz Gerekenler
...
Etkinlik girişinde bilet kontrolü yapılacaktır, biletinizi telefondan göstermeniz gerekmektedir."
        ...
        {/* <div className="concert-box">
          ...
          <p>
            Sevilen sanatçı EMİR CAN İĞREK çok yakında sevenleriyle buluşmaya
            hazırlanıyor
          </p>
        ...
        <div className="concert-box">
          ...
          <p>
            Konser Bilgileri 3: Buraya konser ile ilgili bilgileri
            ekleyebilirsiniz.
          </p>
        ...
        <div className="concert-box">
          ...
          <p>
            Konser Bilgileri 4: Buraya konser ile ilgili bilgileri
            ekleyebilirsiniz.
          </p>
