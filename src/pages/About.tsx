  ...
  return (
    <div className="about-container">
      <div className="about-box">
        <h2>Hoşgeldiniz</h2>
        <p>
        Sizi eğlence dünyasına davet ediyoruz, burada unutulmaz anlar yaşayabilirsiniz! Etkinlik ve organizasyon dünyasında en iyi deneyimi sunmak için buradayız. Tutkulu sanatçılar, etkileyici konserler ve unutulmaz etkinliklerle hayalinizdeki deneyimi sizlere sunuyoruz.
        </p>
      </div>
